...
val SurfaceWrong = Color(0xFF1A0808)
...
val AccentWarm = Color(0xFF7A5030)
...
val TextWarm = Color(0xFFE8D8C0)

// Parts of Speech chips
val PosNoun = Color(0xFF1565C0)
val PosVerb = Color(0xFFE65100)
val PosAdjective = Color(0xFF2E7D32)
val PosAdverb = Color(0xFF6A1B9A)
val PosOther = Color(0xFF546E7A)
val PosChipText = Color(0xFFFFFFFF)

// Mastery scale (16 levels — master → low)
val MasteryMaster4 = Color(0xFF77D228)
val MasteryMaster3 = Color(0xFF99D228)
val MasteryMaster2 = Color(0xFFBBD228)
val MasteryMaster1 = Color(0xFFD2D228)
val MasteryHigh4 = Color(0xFFD2D228)
val MasteryHigh3 = Color(0xFFD2C628)
val MasteryHigh2 = Color(0xFFD2BB28)
val MasteryHigh1 = Color(0xFFD2B028)
val MasteryMedium4 = Color(0xFFD28E28)
val MasteryMedium3 = Color(0xFFD27728)
val MasteryMedium2 = Color(0xFFD26C28)
val MasteryMedium1 = Color(0xFFD26728)
val MasteryLow4 = Color(0xFFD26028)
val MasteryLow3 = Color(0xFFD25728)
val MasteryLow2 = Color(0xFFD24328)
