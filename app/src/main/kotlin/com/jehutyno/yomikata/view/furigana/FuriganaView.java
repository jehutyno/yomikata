...
// Package
package com.jehutyno.yomikata.view.furigana;
...
public class FuriganaView extends androidx.appcompat.widget.AppCompatTextView {
    private class TextFurigana {
        ...
        // Constructor
        public TextFurigana(String text, boolean is_colored) {
            // Info
        ...
        public Span(String text_f, String text_k, int mark_s, int mark_e) {
            ...
            if (mark_s < text_k.length() && mark_e > 0 && mark_s < mark_e) {
                ...
                if (mark_s > 0) {
                    ...
                    if (text_f.length() > 0)
                        m_furigana = new TextFurigana(text_f, false);
                }
                ...
                if (mark_e > mark_s) {
                    ...
                    if (text_f.length() > 0)
                        m_furigana = new TextFurigana(text_f, true);
                }
    ...
    public FuriganaView(Context context) {
        super(context);
        this.setTextSize(Float.parseFloat(PreferenceManager.getDefaultSharedPreferences(context).getString("font_size", "23")));
    }
    ...
    // Text functions
    public void text_set(String text, int mark_s, int mark_e, int color) {
